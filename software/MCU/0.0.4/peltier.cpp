...
float tact = 0, tend = 0 ,valorCalculadoDePWM = 0;
...
bool peltier::cool(bool activate, uint8_t pwmValue,float temperature, float actual_temperature){
    /* SIDE A*/
...
bool peltier::heat(bool activate, uint8_t pwmValue,float temperature, float actual_temperature)
  {
...
// float tact = 0, tend = 0 ,valorCalculadoDePWM = 0;
  ...
  int peltier::definePeltierPID(double aggKp, double aggKd, double aggKi)
  {
    PID pidDirect(&tact,&valorCalculadoDePWM,&tend, &vectorK[0], &vectorK[1], &vectorK[2], DIRECT);
    PID pidReverse(&tact,&valorCalculadoDePWM,&tend, &vectorK[0], &vectorK[1], &vectorK[2] REVERSE);
